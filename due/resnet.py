...
def resnet18(spectral_normalization=True, mod=False, temp=1.0, mnist=False, **kwargs):
    model = ResNet(
        BasicBlock,
        [2, 2, 2, 2],
...
def resnet50(spectral_normalization=True, mod=False, temp=1.0, mnist=False, **kwargs):
    model = ResNet(
        Bottleneck,
        [3, 4, 6, 3],
        spectral_normalization=spectral_normalization,
...
def resnet101(spectral_normalization=True, mod=False, temp=1.0, mnist=False, **kwargs):
    model = ResNet(
        Bottleneck,
        [3, 4, 23, 3],
        spectral_normalization=spectral_normalization,
...
def resnet110(spectral_normalization=True, mod=False, temp=1.0, mnist=False, **kwargs):
    model = ResNet(
        Bottleneck,
        [3, 4, 26, 3],
        spectral_normalization=spectral_normalization,
...
def resnet152(spectral_normalization=True, mod=False, temp=1.0, mnist=False, **kwargs):
    model = ResNet(
        Bottleneck,
        [3, 8, 36, 3],
        spectral_normalization=spectral_normalization,
